    ...
    <div class="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-xl shadow-md">
        ...
        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="input-area">
                ...
                <div>
                    <input id="writer" name="writer" type="text" value="{{ old('writer') }}"
            ...
            <div class="input-area">
                ...
                <div>
                    <input id="number_page" name="number_page" type="number" value="{{ old('number_page') }}"
            ...
            <div class="input-area">
                ...
                <div>
                    <input id="after_discount" name="after_discount" type="number" step="0.01"
                        value="{{ old('after_discount') }}" class="form-control pr-9" placeholder="0.00">
                </div>
            </div>
